...
DEFAULT_CHAT_TEMPLATE = (
    ...
    "- selectTriplet(role, id) — Belirtilen role ve ID'ye sahip tripleti seç/kaldır\\n"
    "- addTriplet(term, category, polarity) — Elle yeni bir triplet ekle (terim, kategori, kutup)\\n"
    "- annotateAll() — Tüm incelemeleri oto-etiketle (tahmin et → seç → kaydet → ilerle)\\n"
    "\\n"
